...
import { ConventionResponseRow } from "./response-row";

interface Props {
  sequence: Bid[];
  setSequence: (s: Bid[]) => void;
  responses: ModifiedConventionResponse[];
}
...
export function ConventionResponsesTable(props: Props) {
  return (
    <Card
      id="responses-table"
      padding={false}
