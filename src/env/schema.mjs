...
const BASE_URL_SCHEMA = z.preprocess(
  // This makes Vercel deployments not fail if you don't set BASE_URL
...
export const serverSchema = z.object({
  ...
  BASE_URL: BASE_URL_SCHEMA,
  NEXTAUTH_URL: BASE_URL_SCHEMA,
...
export const clientSchema = z.object({
  ...
  NEXT_PUBLIC_BASE_URL: BASE_URL_SCHEMA,
