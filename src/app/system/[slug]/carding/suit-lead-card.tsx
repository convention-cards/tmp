...
export function SuitLeadsCard() {
  return (
    <Card id="suit-leads" title="Leads against Suit Contracts">
      <dl className="grid grid-cols-1 gap-x-4 gap-y-8 sm:grid-cols-2">
        <div className="sm:col-span-2">
          <dt className="text-sm font-medium text-gray-500">Primary Method</dt>
          <dd className="mt-1 text-sm text-gray-900">3rd and Low</dd>
        </div>
        <div className="sm:col-span-2">
        ...
        <div className="sm:col-span-2">
          ...
          <dd className="mt-1 text-sm text-gray-900">
            Sometimes attitude leads if count is &ldquo;known&rdquo;
          </dd>
        </div>
      </dl>
    </Card>
